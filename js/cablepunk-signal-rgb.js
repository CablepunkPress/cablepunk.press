...
(function() {
    ...
    function getRedColor(brightness, opacity) {
        ...
        const b = Math.floor(brightness * 30);
    ...
    function getRandomColorFunction() {
        const colors = [getRedColor, getGreenColor, getBlueColor];
        ...
        stream.update = function() {
            ...
            if (stream.trail.length > 0) {
                ...
                if (lastY > canvas.height + stream.fontSize * stream.trailLength) {
                    ...
                    stream.colorFn = getRandomColorFunction();
                }
            }
        };
